...
public class RegisterDoctorActivityAppiumTest {
    ...
    public void setUp() throws MalformedURLException {
        ...
        caps.setCapability("appActivity", "com.example.safesleep.RegisterDoctorActivity");
        driver = new AndroidDriver<>(new URL("http://localhost:4723/wd/hub"), caps);
    }

    @Test
    public void testRegisterDoctorActivityLaunches() {
