...
public class SleepPostureActivityAppiumTest {
    ...
    public void setUp() throws MalformedURLException {
        ...
        caps.setCapability("appActivity", "com.example.safesleep.SleepPostureActivity");
        driver = new AndroidDriver<>(new URL("http://localhost:4723/wd/hub"), caps);
    }

    @Test
    public void testSleepPostureActivityLaunches() {
