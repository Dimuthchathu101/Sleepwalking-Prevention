...
public class TimeAnalysisActivityAppiumTest {
    ...
    public void setUp() throws MalformedURLException {
        ...
        caps.setCapability("appActivity", "com.example.safesleep.TimeAnalysisActivity");
        driver = new AndroidDriver<>(new URL("http://localhost:4723/wd/hub"), caps);
    }

    @Test
    public void testTimeAnalysisActivityLaunches() {
